...
async function seedDatabase() {
    try {
        ...
        await user_1.default.updateMany({ _id: { $in: [ava._id, mia._id] } }, { $set: { team: sunriseStriders._id } });
        await user_1.default.updateMany({ _id: { $in: [noah._id, liam._id] } }, { $set: { team: ironPulse._id } });
        const now = new Date();
